...
The repository already includes Rohullah Rezai’s portrait at `assets/profile-source.png`. The generator uses this image as the source for the animated ASCII portrait. If you replace it later, use:
...
```text
Set up the Aqua Launch GitHub profile template for Rohullah Rezai in this repository for me.

My details:
- GitHub username: rohullahr914-pixel
- Full name: Rohullah Rezai
- ASCII wordmark, maximum 8 characters: ROHULLAH
- Role: AI Engineer · Founder · Full-Stack Developer
- Location: Building remotely · Global
- Short status: Building intelligent systems, AI agents and products for the future.
- Website: https://github.com/rohullahr914-pixel
- Skills, maximum 6: AI Agents, Next.js, TypeScript, Python, FastAPI, Three.js
- Contact email: (not included)
